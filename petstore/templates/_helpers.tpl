...
helm.sh/chart: {{ include "petstore.chart" . }}
...
*/}}
{{- define "petstore.serviceAccountName" -}}
{{- if .Values.serviceAccount.create }}
{{- default (include "petstore.fullname" .) .Values.serviceAccount.name }}
{{- else }}
